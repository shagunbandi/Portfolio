        ...
        <div className="footer container-xl width-full p-responsive" role="contentinfo">
            <div
                ...
                <ul
                    ...
                    <li className="mr-3 mr-lg-0">Template taken from 2020 GitHub, Inc.</li>
                    <li className="mr-3 mr-lg-0"><a href="https://www.linkedin.com/in/shagunbandi/">LinkedIn</a></li>
                    <li className="mr-3 mr-lg-0"><a href="https://github.com/shagunbandi">Github</a></li>
                    <li className="mr-3 mr-lg-0"><a href="https://instagram.com/poha.jalebi.sev">Instagram</a></li>
                </ul>

                <a aria-label="Homepage" title="GitHub" className="footer-octicon d-none d-lg-block mx-lg-4"
                    href="https://github.com">
                    <svg height="24" className="octicon octicon-mark-github" viewBox="0 0 16 16" version="1.1" width="24"
                        aria-hidden="true">
