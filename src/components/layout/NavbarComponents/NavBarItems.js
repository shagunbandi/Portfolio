    ...
    render() {
        return (
            <nav className="d-flex flex-column flex-lg-row flex-self-stretch flex-lg-self-auto" aria-label="Global">
                ...
                <a className="Header-link d-block d-lg-none mr-0 mr-lg-3 py-2 py-lg-3 border-top border-lg-top-0 border-white-fade-15"
                    href="/shagunbandi">
                    <img className="avatar avatar-user" src="https://avatars1.githubusercontent.com/u/18301341?s=40&amp;v=4"
