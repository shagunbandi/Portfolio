...
export class ColorTop extends Component {
    render() {
        ...
        const techie = (
            <span>
                ...
                <span class="num text-emphasized">&nbsp;Technophile</span>
            </span>
        )
        const hodophile = (
            <span>
                <svg class="octicon octicon-git-branch" viewBox="0 0 10 16" version="1.1" width="10" height="16" aria-hidden="true">
                ...
                <span class="num text-emphasized">&nbsp;Hodophile</span>
            </span>
        )
        ...
        const epicure = (
            <span>
                ...
                <span class="num text-emphasized">&nbsp;Epicure</span>
            </span>
        )
        ...
        const photographer = (
            <span>
                ...
                <span class="num text-emphasized">&nbsp;Photographer</span>
            </span>
        )
        ...
        return (
            <div class="overall-summary border-bottom-0 mb-0 rounded-bottom-0">
                ...
                <ul class="numbers-summary hide-when-large">
                    <li className="hide-when-small">
                        {techie}
                    </li>
                    <li className="hide-when-small">
...
export default connect()(ColorTop);
